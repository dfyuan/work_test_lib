...
#define MRV_IF_SELECT_MIPI_2                    3   // 3: 2nd MIPI-interface
#endif /* MRV_IF_SELECT */
...
// Note: Allow 1 bit less than maximum dx value, because dx value is signed,
//       and max_dx is the maximum of absolute value of dx
#define MRV_IS_IS_MAX_DX_MAX ( MRV_IS_DX_MASK >> (MRV_IS_DX_SHIFT + 1) )
...
// Note: Allow 1 bit less than maximum dy value, because dy value is signed,
//       and max_dy is the maximum of absolute value of dy
#define MRV_IS_IS_MAX_DY_MAX ( MRV_IS_DY_MASK >> (MRV_IS_DY_SHIFT + 1) )
