...
LOCAL_SRC_FILES:=\
	source/vom_ctrl.c\
	source/vom_ctrl_api.c\
	source/vom_ctrl_hdmi.c\
	source/vom_ctrl_mvdu.c
...
LOCAL_WHOLE_STATIC_LIBRARIES := libisp_common libisp_bufferpool
#LOCAL_MODULE_PATH := $(TARGET_OUT_SHARED_LIBRARIES)/hw
LOCAL_MODULE:= libisp_vom_ctrl
