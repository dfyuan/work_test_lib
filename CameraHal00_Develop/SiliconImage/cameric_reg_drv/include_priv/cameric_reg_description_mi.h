...
static RegDescription_t MiRegisterMap[] =
{
    ...
    { 0U, PERM_READ_WRITE, "MI_MP_Y_BASE_AD_INIT2"  , "Base address 2 (ping pong) for main picture Y component"                                            , 0x00000000, 0xFFFFFFF8, 0x00000000 },
    { 0U, PERM_READ_WRITE, "MI_MP_CB_BASE_AD_INIT2" , "Base address 2 (ping pong) for main picture Cb component"                                           , 0x00000000, 0xFFFFFFF8, 0x00000000 },
    { 0U, PERM_READ_WRITE, "MI_MP_CR_BASE_AD_INIT2" , "Base address 2 (ping pong) for main picture Cr component"                                           , 0x00000000, 0xFFFFFFF8, 0x00000000 },
    { 0U, PERM_READ_WRITE, "MI_SP_Y_BASE_AD_INIT2"  , "Base address 2 (ping pong) for self picture Y component"                                            , 0x00000000, 0xFFFFFFF8, 0x00000000 },
    { 0U, PERM_READ_WRITE, "MI_SP_CB_BASE_AD_INIT2" , "Base address 2 (ping pong) for self picture Cb component"                                           , 0x00000000, 0xFFFFFFF8, 0x00000000 },
    { 0U, PERM_READ_WRITE, "MI_SP_CR_BASE_AD_INIT2" , "Base address 2 (ping pong) for self picture Cr component"                                           , 0x00000000, 0xFFFFFFF8, 0x00000000 },
    { 0U, PERM_READ_WRITE, "MI_XTD_FORMAT_CTRL"     , "Extended Storage Format Control"                                                                    , 0x00000000, 0x00000007, 0x00000000 }
};
