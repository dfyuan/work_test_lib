...
static const struct UVC_FRAME_UNCOMPRESSED(5) uvc_frame_yuv_360p = {
	...
	.wHeight		= cpu_to_le16(722),
	.dwMinBitRate		= cpu_to_le32(1280*722*2*8*30),
	.dwMaxBitRate		= cpu_to_le32(1280*722*2*8*30),
	.dwMaxVideoFrameBufferSize	= cpu_to_le32(1280*722*2),
	.dwDefaultFrameInterval	= cpu_to_le32(333333),
//	.wWidth			= cpu_to_le16(1280),
//	.wHeight		= cpu_to_le16(962),
//	.dwMinBitRate		= cpu_to_le32(1280*962*2*8*30),
//	.dwMaxBitRate		= cpu_to_le32(1280*962*2*8*30),
//	.dwMaxVideoFrameBufferSize	= cpu_to_le32(1280*962*2),
//	.dwDefaultFrameInterval	= cpu_to_le32(333333),
...
static const struct UVC_FRAME_UNCOMPRESSED(2) uvc_frame_yuv_720p = {
	...
	.dwMinBitRate		= cpu_to_le32(1280*962*2*8*30),
	.dwMaxBitRate		= cpu_to_le32(1280*962*2*8*30),
	.dwMaxVideoFrameBufferSize	= cpu_to_le32(1280*960*2),
	.dwDefaultFrameInterval	= cpu_to_le32(333333),
	.bFrameIntervalType	= 1,
	.dwFrameInterval[0]	= cpu_to_le32(333333),
